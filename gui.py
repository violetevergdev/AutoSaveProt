...
def run_program():
    ...
    main(login, password, start_date, end_date, operation_type, server)
...
moscow_radio = tk.Radiobutton(settings_frame, text="Москва", variable=selected_server, value="Москва")
moscow_radio.pack(side=tk.LEFT, padx=5)
region_radio = tk.Radiobutton(settings_frame, text="Область", variable=selected_server, value="Область")
